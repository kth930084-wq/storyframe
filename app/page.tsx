        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className={`lg:col-span-7 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-wrap gap-4 mb-16">
              <a href="#login" className="group flex items-center gap-3 px-7 py-4 bg-white text-neutral-900 font-bold rounded-xl hover:bg-neutral-100 transition-all text-sm shadow-lg shadow-white/10">
                무료로 시작하기
